<template>
  <div class="p-2 text-left">
    ...
    <el-table :data="tableData" border>
      <el-table-column header-align="center" label="网站名称" prop="siteName" width="220"></el-table-column>
      <el-table-column header-align="center" label="网站logo" prop="logo" width="200"></el-table-column>
      <el-table-column header-align="center" label="网站链接" prop="link" width="200"></el-table-column>
